...
function I18n(opts){
  if(opts){
    ...
    // Valid languages
    var enabled_locales = opts.locales        || false
  ...
  this.locales = _.union( [this.defaultLocale], _.keys(this.translation) )
}
...
I18n.prototype.translate = function(text, locale, defaultLocale){
  /*
  ...
  // If the locale is the default, get leave it like it is
...
I18n.prototype.prepare = function(){
  return (function(text){
    return this.translate(text, this.locale, this.defaultLocale)
  }).bind(this)
}
